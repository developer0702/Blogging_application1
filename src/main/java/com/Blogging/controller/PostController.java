...
public class PostController {
	...
	// get post data by user
	// http://localhost:8080/api/v1/user/2/posts
	...
	// http://localhost:8080/api/v1/category/2/posts
	...
	public ApiResponse deletePostById(@PathVariable Integer postId) {
		...
		return new ApiResponse("User deleted successfully", false);
	}
